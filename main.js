var todoList = {  
    ...
    deleteCompletedTodos: function() {  
     // Evita problemas al borrar los todos. 
   ...
   var handlers = {  
    addTodo: function() {  
     ...
     // prueba si addTodoTextInput.value no es un campo vacio.  
   ...
   var view = {  
    ...
    displayTodos: function() {  
     ...
     view.filteredTodos.forEach(function(todo, position) {  
      ...
      // Si el todo esta completo se le asigna una clase  
      if (todo.completed === true) {  
    ...
    checkTodosCompletion: function() {  
     ...
     switch(uncompletedTodos) {  
      case 0:  
       ...
       break;  
      default:  
       todosLeftLabel.textContent = "Tareas Pendientes: " + uncompletedTodos;  
     }  
    },  
